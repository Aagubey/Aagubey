...
class _BotCommands:
    def __init__(self):
        ...
        self.MirrorCommand = f'drive{CMD_INDEX}'
        self.UnzipMirrorCommand = f'unzipdrive{CMD_INDEX}'
        self.ZipMirrorCommand = f'zipdrive{CMD_INDEX}'
        self.CancelMirror = f'cancel{CMD_INDEX}'
        self.CancelAllCommand = f'cancelall{CMD_INDEX}'
        self.ListCommand = f'searchindrive{CMD_INDEX}'
        ...
        self.QbMirrorCommand = f'qbdrive{CMD_INDEX}'
        self.QbUnzipMirrorCommand = f'qbunzipdrive{CMD_INDEX}'
        self.QbZipMirrorCommand = f'qbzipdrive{CMD_INDEX}'
        ...
        self.LeechZipWatchCommand = f'zipytdl{CMD_INDEX}'
